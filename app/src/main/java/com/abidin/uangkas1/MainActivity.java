...
public class MainActivity extends AppCompatActivity {
    ...
    @Override
    protected void onCreate(Bundle savedInstanceState) { // void "procedure"
    ...
    @Override
    public boolean onCreateOptionsMenu(Menu menu) { // function bertipe data dan memiliki nilai return
    ...
    private void KasAdapter(){
        ...
        list_kas.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                transaksi_id = ((TextView) view.findViewById(R.id.text_transaksi_id)).getText().toString(); // cara memanggil fragment
                list_menu();
    ...
    private void Hapus(){
        AlertDialog.Builder builder = new AlertDialog.Builder(this); // membuat message dialog
